...
toilet -f big -F border "DeAuhter" | lolcat

echo "        [ BY: Flyzone84 | v1.0 ]" | pv -qL 40 | lolcat

printf "\n"

echo "             [ Tool to DeAuth Full WiFi Network Near-You]" | pv -qL 40 | lolcat
...
toilet -f term -F border "ONLY use EDUCATIONAL purpose" | lolcat
printf "\n"
